...
```json
{"event":"auth_prune_completed","deletedTransactions":0,"deletedSessions":0,"deletedLogoutReplays":0,"deletedRateLimits":0,"deletedNativeHandoffs":0,"deletedNativeBridges":0,"deletedNativeBridgeNonces":0,"deletedActionResults":0,"deletedDeletionIntents":0,"scrubbedDeletionRecovery":0}
```
